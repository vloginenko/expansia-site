...
const faq = [
  {
    ...
    a: "SMM продаёт время сотрудников. Мы — результат в просмотрах и заявках, закреплённый в договоре. Внутри не редакция из людей, а AI-конвейер с продюсером сверху. Поэтому объёма в 5–10 раз больше при цене в 5–7 раз ниже.",
  },
  {
