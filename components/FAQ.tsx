...
const faq = [
  ...
  },
  {
    ...
    a: "От подписания договора до первого опубликованного ролика — 14 дней. Это твёрдый срок, прописан в договоре, за просрочку по нашей вине компенсируем неделю работы. Первые два месяца — фаза разгона: алгоритмам нужно собрать сигнал. Стабильные результаты по KPI — с третьего месяца, и это мы тоже предупреждаем сразу, чтобы не было сюрпризов.",
  },
  {
    q: "А не забанят аккаунты за AI-контент?",
    a: "За AI как таковой никого не банят — TikTok и Reels к этому уже привыкли. Банят за две вещи: одинаковые видео и подозрительные аккаунты. Мы закрываем оба пункта: каждый ролик уникален по сценарию, монтажу и аудио (см. секцию «Внутри фабрики»), а аккаунты идут с белыми мобильными IP и проходят 7–10 дней прогрева перед первой публикацией. За shadowban по нашей вине — восстановление за наш счёт, это в гарантиях.",
  },
  {
    q: "Сколько стоит один ролик в вашем конвейере?",
    a: "В тарифе START — около 6 000 ₽ за единицу контента «под ключ» (включая сценарий, аватара, B-roll, монтаж, субтитры, постинг и долю воронки). В Enterprise — около 5 750 ₽. У классического агентства цена за ролик того же качества начинается от 25–40 тысяч. Если считать только AI-генерацию без воронки и продюсера (как в self-serve CG Pro) — там 190 ₽ за ролик.",
  },
  {
...
export default function FAQ() {
  ...
  return (
    <Section id="faq" number="11" label="ВОПРОСЫ">
      <div className="mb-12">
