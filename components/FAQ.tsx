...
const faq = [
  ...
  },
  {
    ...
    a: "От подписания договора до первого опубликованного ролика — 14–21 день. Первые два месяца — фаза разгона: алгоритмам нужно собрать сигнал. Стабильные результаты по KPI — с третьего месяца. Мы предупреждаем это сразу, чтобы не было сюрпризов.",
  },
  {
                ...
                {isOpen && (
                  ...
                  >
                    <div className="grid grid-cols-[80px_1fr] gap-6 px-6 pb-8 lg:px-8">
                      <div />
                      <p className="max-w-[700px] text-[15px] leading-[1.65] text-ink/80 lg:text-[16px]">
                        {f.a}
                      </p>
                    </div>
                  </motion.div>
