...
const steps = [
  ...
  },
  {
    ...
    body: "Делаем нейроаватара (или используем готового актёра), подбираем голос, настраиваем шрифты и стиль монтажа под ваш бренд.",
    tag: "4 дня",
  },
  {
    n: "03",
    title: "Производство",
    body: "AI пишет сценарии, делает нейроаватара, монтирует и публикует. От 3 аккаунтов на платформу — чтобы ролики не теряли друг друга в ленте. Продюсер фильтрует и докручивает.",
    tag: "ежедневно",
  },
  {
    n: "04",
  ...
  },
  {
    ...
    body: "Недельный отчёт с цифрами, не со слайдами. Проверяем гипотезы на хуках и обложках. Что работает — масштабируем, что нет — заменяем.",
    tag: "weekly",
  },
];
