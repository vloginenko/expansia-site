...
const items = [
  ...
  },
  {
    ...
    body: "Если в конце месяца план по просмотрам не закрыт — следующий месяц работаем без оплаты, пока цифру не выведем. Это в договоре, не в обещаниях.",
  },
  {
    n: "§5.4",
    title: "Старт за 7 дней",
    body: "От подписания договора до первого ролика в эфире — неделя. Задержимся по нашей вине — компенсируем неделю работы.",
  },
  {
    n: "§5.5",
      ...
      <div className="mb-14 grid grid-cols-1 gap-8 lg:grid-cols-[1.2fr_1fr] lg:gap-16">
        ...
        <div className="flex items-end">
          <p className="max-w-[480px] text-[16px] leading-[1.6] text-ink/90 lg:text-[18px]">
            Работаем по договору с фиксированным KPI. Не добрали — догоняем
            за&nbsp;свой счёт. Платите за&nbsp;результат, а не за процесс.
          </p>
        </div>
      </div>
